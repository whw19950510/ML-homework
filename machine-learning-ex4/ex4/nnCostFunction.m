...
for i=1:m
    for j=1:num_labels
        J=J+(-ytrain(i,j)*log(a3(i,j))-(1-ytrain(i,j))*log(1-a3(i,j)));
    end
end
J=J/m;
...
for i=1:m
    ...
    for j=1:num_labels
        ...
        delta3(1,j)=a3(1,j)-yk;
    end
    temp=Theta2'*delta3';
    temp=temp(2:end,1);
    delta2=temp.*sigmoidGradient(z2');%25*1
